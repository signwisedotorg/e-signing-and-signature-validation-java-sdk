...
public class TestContainerCreate {
	...
	public static void main(String[] args)
	{
		try {
			...
			System.out.println("Create container: " + sCnt + " in: " + sOutPath + " from path: " + sInPath + " file: " + sInFile + " mime: " + sInMime);
			...
			ServerResponse sResp = conn.serviceContainerCreate(sCnt, sOutPath, bOverwrite, files);
