...
/**
 * BDOC Signature confirmation info returned by SignWise services
 */
public class BDocSignatureConfirmationInfo {
	...
	/**
	 * Constructor for BDocSignatureConfirmationInfo
	 * @param responderId OCSP responder id
	 * @param producedAt OCSP response producedAt time
	*/
	public BDocSignatureConfirmationInfo(String responderId, Date producedAt)
	{
	 ...
	 */
	public BDocSignatureConfirmationInfo(JSONObject jobj)
	{
