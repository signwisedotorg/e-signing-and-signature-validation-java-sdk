...
/**
 * PDF Signature timestamp info returned by SignWise services
 */
public class PdfSignatureTimestampInfo {
	...
	/**
	 * Constructor for PdfSignatureTimestampInfo
	 * @param created timestamp creation time
	*/
	public PdfSignatureTimestampInfo(Date created)
	{
		m_created = created;
	}
	 ...
	 */
	public PdfSignatureTimestampInfo(JSONObject jobj)
	{
